...
export default class MetricsManager {
  ...
  async updateNodeMetrics() {
    try {
      ...
      logger.error('Error updating node metrics', { error: error.message });
    }
  }
  ...
  async updateTaskMetrics() {
    try {
      ...
      logger.error('Error updating task metrics', { error: error.message });
    }
  }
  ...
  async updateNetworkMetrics() {
    try {
      ...
      logger.error('Error updating network metrics', { error: error.message });
    }
  }
  ...
  async updateBillingMetrics() {
    try {
      ...
      logger.error('Error updating billing metrics', { error: error.message });
    }
  }
