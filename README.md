...
- LOD（Level of Detail）渲染，支持万级节点流畅展示
- 节点悬浮高亮、点击详情、关系链路追踪
- 多视图切换：世界地图 / 3D 力导向图 / 3D 星球 / 社交图谱 / OSINT 流 / **3D 星系**（Phase 13）
...
### 📋 任务系统
- **Temporal Workflows** 驱动的任务编排
- 多因素优先级调度 + 自动重试 + 熔断机制（opossum）
...
- **联邦路由** — 跨网络任务分发，支持最多 5 跳转发（MAX_HOPS）
